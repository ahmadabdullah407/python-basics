...
# r_phrase = ""
# for item in p_phrase:
#     r_phrase = item + r_phrase
# print(r_phrase)
# if r_phrase == p_phrase:
#     print("\"{}\" is a palindrome".format(p_phrase))
# else:
#     print("\"{}\" is not a palindrome".format(p_phrase))
